"""A controlled, reproducible performance benchmark for Minecraft mods.
...
no variance estimate, which cannot distinguish a real effect from thermal drift.
mcbench makes that distinction, for client and server alike.
